...
public class CartTest {
    ...
    public void addValidItem() {
        Spares s = new Spares("P001","Piston","Bajaj", 4500.0,15,"Engine","2024","img.jpg", 10);
    ...
    public void exceedStock() {
        Spares s = new Spares("P001","Piston","Bajaj", 4500.0,5,"Engine","2024","img.jpg",10);
        assertFalse(cart.addItem(s, 10));
    }

    @Test
    public void removeItem() {
        Spares s = new Spares("P001","Piston","Bajaj", 1000.0,15,"Engine","2024","img.jpg",10);
        cart.addItem(s, 2);
