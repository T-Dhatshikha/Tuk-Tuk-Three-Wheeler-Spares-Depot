...
public class LowStockMonitorTest {
    ...
    public void lowThresholdStock() {
        Spares s = new Spares("P001", "Test", "Brand", 1000.0, 5, "Engine", "2024", "img.jpg");
        assertTrue(monitor.isLowStock(s));
    }

    @Test
    public void aboveThresholdStock() {
        Spares s = new Spares("P001", "Test", "Brand", 1000.0, 15, "Engine", "2024", "img.jpg");
        assertFalse(monitor.isLowStock(s));
    }

    @Test
    public void equalThresholdStock() {
        Spares s = new Spares("P001", "Test", "Brand", 1000.0, 10, "Engine", "2024", "img.jpg");
        assertFalse(monitor.isLowStock(s));
    }

    @Test
    public void zeroQuantityStock() {
        Spares s = new Spares("P001", "Test", "Brand", 1000.0, 0, "Engine", "2024", "img.jpg");
        assertTrue(monitor.isLowStock(s));
    }
    ...
    public void customThreshold() {
        ...
        Spares s = new Spares("P001", "Test", "Brand", 500.0, 7, "Engine", "2024", "img.jpg");
    ...
    public void getLowStockCount() {
        Spares[] parts = {
                new Spares("P001","A","B",100,5, "Engine","2024","i.jpg"),
                new Spares("P002","B","B",200,15, "Brakes","2024","i.jpg"),
                new Spares("P003","C","B",300,3, "Electrical","2024","i.jpg")
        };
    ...
    public void thresholdUpdates() {
        Spares[] parts = {
                new Spares("P001","A","B",100,8, "Engine","2024","i.jpg"),
                new Spares("P002","B","B",200,15, "Brakes","2024","i.jpg"),
                new Spares("P003","C","B",300,25, "Electrical","2024","i.jpg")
        };
